...
{
    /**
     * Bootstrap inventory locations for seeded demo domains (idempotent via firstOrCreate).
     */
    public function run(): void
    {
        ...
        foreach ($domains as $domain) {
            ...
            $customerCode = match ($domain->name_slug) {
                'jollibee-corp' => 'JB-CUST',
                'mcdonalds-corp' => 'MC-CUST',
                default => 'CUST',
            };
