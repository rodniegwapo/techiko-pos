        ...
        >
          ...
          <template #bodyCell="{ column, record }">
            ...
            <template v-else-if="column.key === 'type'">
              <a-tag class="w-fit" :color="record.type_badge.color">
            ...
            <template v-else-if="column.key === 'address'">
              <div v-if="record.address" class="text-sm text-gray-600">
                {{ record.address }}
              </div>
              <span v-else class="text-gray-400 text-sm">No address</span>
            </template>
            ...
            <template v-else-if="column.key === 'status'">
              <a-tag class="w-fit" :color="record.status_badge.color">
              ...
              <div class="flex justify-center space-x-1">
                ...
                <a-dropdown>
                  <IconTooltipButton name="More Actions">
                    <SettingOutlined :size="20" class="mx-auto" />
                  </IconTooltipButton>
                  <template #overlay>
                    <a-menu>
                      <a-menu-item
          ...
          <template #emptyText>
            <div class="text-center py-8">
              <IconBuilding :size="48" class="mx-auto text-gray-400 mb-4" />
