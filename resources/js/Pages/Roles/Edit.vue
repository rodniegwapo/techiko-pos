    ...
    level: [
        { required: true, message: "Please enter a role level" },
        {
            validator: (_rule, value) => {
                if (value == null || value === "")
                    return Promise.reject("Please enter a role level");
                const num = Number(value);
                if (!Number.isInteger(num))
                    return Promise.reject("Level must be an integer");
                if (num < 1 || num > 99)
                    return Promise.reject("Level must be between 1 and 99");
                        ...
                        >
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <a-checkbox
                                    ...
                                    :indeterminate="
                                        isModuleIndeterminate(moduleName)
                                    "
                                    @change="
                                        onModuleCheckAllChange(
                                            moduleName,
                ...
                <a-card class="shadow-sm">
                    ...
                    <div class="flex items-center space-x-4">
                        <a-avatar
                            :size="64"
                            :style="{
                                backgroundColor: getRoleColor(form.name),
                            }"
                        >
                            <IconShield size="32" />
                        </a-avatar>
